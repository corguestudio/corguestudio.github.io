...
PetiteVue.createApp({
	data: [['玩法设计', '制定核心玩法机制与关卡难度曲线设计', 100], ['制谱器开发', '构建直观的谱面编辑工具，支持可视化音符布局', 100], ['游戏核心开发', '完善打击判定系统与音频处理引擎', 85],
		['UI系统重置', '重新设计游戏界面，优化视觉反馈体验', 54], ['内部测试阶段', '进行性能优化与游戏平衡性调整', 36], ['谱面内容制作', '创作并调校多样化难度的游戏谱面', 21],
		['内测版本准备', '完善新手引导及性能优化', 12], ['b/*@<HP8', 'aV6Rq=^!d\'9AH8(|=QebkPG;/Q|Rg7iO', 20]]
}).mount('#progress');
next();